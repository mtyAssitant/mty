 (function (a) {
        ...
        o.show = function (j) {
            ...
            for (var d = '<div class="dw-trans ' + p.theme + " dw-" + p.display + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' + f + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (p.headerText ? '<div class="dwv"></div>' : "")), j = 0; j < p.wheels.length; j++) {
                ...
                for (e in p.wheels[j]) $[b] = p.wheels[j][e],
                    d += '<td><div class="dwwl dwrc dwwl' + b + '">' + ("scroller" != p.mode ? '<div class="dwwb dwwbp" style="height:' + N + "px;line-height:" + N + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + N + "px;line-height:" + N + 'px;"><span>–</span></div>' : "") + '<div class="dwl">' + e + '</div><div class="dww" style="height:' + p.rows * N + "px;min-width:" + p.width + 'px;"><div class="dw-ul">',
                    d += m(b),
        ...
        o.cancel = function () {
        !1 !== o.hide(!1, "cancel") && L("onCancel", [o.val])
        };
        o.init = function (a) {
            aa = G({
                defaults: {},
